...
public class GameActivityExtreme extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getNumber.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(userChoice>0 && userChoice<101){
                    if(userChoice==0)
                    {
                        Intent intent=new Intent(GameActivityExtreme.this,MainActivity.class);
                        ...
                        if (getLevel.checkAnswerCorrect(randomNum, userChoice) == true) {
                            ...
                            currentPoints = getLevel.gethighscore(currentPoints, "extreme", pointsCounter);
        ...
        tohome.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                ((TextView) findViewById(R.id.extremeScore)).setText(output);
